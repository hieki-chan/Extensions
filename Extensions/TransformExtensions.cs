...
namespace UnityE.Extensions
{
    public static class TransformExtensions
    {
        ...
        /// </summary>
        /// <returns></returns>
        public static Transform FindCloset(this Transform source, IEnumerable<Transform> otherTransforms)
        {
            ...
            {
                float distance = (source.position - transform.position).sqrMagnitude;

                if (distance < shortestDistance)
                {
                    shortestDistance = distance;
                    closetTransform = transform;
                }
            }
